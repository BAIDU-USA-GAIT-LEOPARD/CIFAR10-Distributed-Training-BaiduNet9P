...
class ImageDataBunch(DataBunch):
    ...
    def create_from_ll(cls, lls:LabelLists, bs:int=64, val_bs:int=None, ds_tfms:Optional[TfmList]=None,
        ...
        _data_transformation_time = timer2 - timer1
        if torch.cuda.current_device() == rand_gpu_id:
            print("data transformation time is ", _data_transformation_time, "s")
    ...
    def normalize(self, stats:Collection[Tensor]=None, do_x:bool=True, do_y:bool=False)->None:
        ...
        timer2 = time.process_time()
        _data_normalization_time = timer2 - timer1
        if torch.cuda.current_device() == rand_gpu_id:
            print("data normalization time is ", _data_normalization_time, "s")
